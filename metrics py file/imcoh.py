...
subjects = [subject for subject in os.listdir('/work/erikc/EEG_CON/inspected') if subject.startswith('sub')]
...
for subject in subjects:
    try:
        ...
        for condition in conditions:
            ...
            raw = mne.io.read_raw_eeglab(f"/work/erikc/EEG_CON/eeg/{subject}/{subject}_{condition}.set")
            ...
            for i in range(100):
                ...
                mne_con = spectral_connectivity_epochs(np.array(label_ts)[inds], 
                                                   method="imcoh", sfreq=250, mode='multitaper', 
            ...
            xarray.to_netcdf(f'imcoh_results/{subject}_array_imcoh_{condition}.nc')
    except:
        continue
