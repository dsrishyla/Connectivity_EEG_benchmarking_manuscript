#!/bin/bash
#SBATCH --job-name=gpdc_gpu     # Name of the job
#SBATCH --output=log_gpdc_freqs.out    # Output file name pattern (%A for array master ID, %a for array index)
#SBATCH --error=log_gpdc_freqs.err      # Error file name pattern
