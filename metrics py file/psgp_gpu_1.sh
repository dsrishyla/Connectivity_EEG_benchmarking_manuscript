#!/bin/bash
#SBATCH --job-name=psgp_gpu1     # Name of the job
#SBATCH --output=log_psgp_freqs1.out    # Output file name pattern (%A for array master ID, %a for array index)
#SBATCH --error=log_psgp_freqs1.err      # Error file name pattern
