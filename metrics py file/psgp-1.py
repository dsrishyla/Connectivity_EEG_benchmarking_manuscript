...
subjects.remove('sub-032328')
subjects.remove('sub-032356')
subjects.remove('sub-032368')
subjects.remove('sub-032462')
subjects.remove('sub-032463')
subjects.remove('sub-032472')
subjects.remove('sub-032473')
subjects.remove('sub-032528')
subjects.remove('sub-032514')
subjects.remove('sub-032510')
subjects.remove('sub-032502')
subjects.remove('sub-032484')
subjects.remove('sub-032467')
subjects.remove('sub-032353')


subjects.sort()
#Only take the first half of the subjects
subjects = subjects[:int(len(subjects)/2)]
...
for subject in subjects:
    try:
        for condition in conditions:
            ...
            xarray.to_netcdf(f'./psgp/{subject}_array_psgp_{condition}.nc')
